...
More information will come shortly. The current version has a minimal set of features - the work right now is to basically "port" the RubyKoans to C#, then add additional Koans where it makes sense.
